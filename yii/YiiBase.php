 ...
 */
// defined('YII_DEBUG') or define('YII_DEBUG',false); - Moved to config file
/**
 ...
 */
// defined('YII_TRACE_LEVEL') or define('YII_TRACE_LEVEL',0); - Moved to config file
/**
 * This constant defines whether exception handling should be enabled. Defaults to true.
 */
// defined('YII_ENABLE_EXCEPTION_HANDLER') or define('YII_ENABLE_EXCEPTION_HANDLER',true); - Moved to config file
/**
 * This constant defines whether error handling should be enabled. Defaults to true.
 */
// defined('YII_ENABLE_ERROR_HANDLER') or define('YII_ENABLE_ERROR_HANDLER',true); - Moved to config file
/**
