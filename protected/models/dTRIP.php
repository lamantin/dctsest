...
class dTRIP {
    ...
    public function __construct($ip, $cidr = NULL) {
        ...
        /**         * */
        $this->ip_long = $this->dtr_pton($this->ip);
        ...
        /** Detect if it is a valid IPv6 Address * */ elseif (filter_var($this->ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6)) {
    ...
    public function __toString() {
        ...
        return json_encode(
                array(
                    "ip" => $this->ip,
                    "cidr" => $this->cidr,
                    "netmask" => $this->dtr_ntop($this->netmask),
    ...
    public function __call($method, $args) {
        ...
        /** Is there a version specific function? * */ elseif (method_exists($this, $method . "_v" . $this->version)) {
    ...
    public function network() {
        ...
        return $this->network = $this->dtr_ntop($network);
    }
    ...
    function netmask_v4() {
        ...
        return $this->dtr_pton(long2ip($netmask));
    }

    public function netmask_v6() {
        $hosts = (128 - $this->cidr);
        $networks = 128 - $hosts;
    ...
    public function broadcast() {
        ...
        $this->broadcast =$this->dtr_ntop($broadcast);
    ...
    public function getNetmask() {
        return $this->dtr_ntop($this->netmask);
    }
     ...
     * @return string $bin
     */
    protected function dtr_pton($ip) {
     ...
     * @return string $ip
     */
    protected function dtr_ntop($str) {
